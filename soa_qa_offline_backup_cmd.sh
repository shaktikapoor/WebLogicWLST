...
backup_parent_dir="/app_data/soa_backup/backup_server/offline_backup/$(hostname -s)/QA"
...
#echo "$opt"
    ...
    case $opt in
        "soa domain backup")
            ...
            backup_me="/app_domain/OFM_Domains/OFM_QA/user_projects/qa_soa_domain"
        ...
        "soa binary backup")
            ...
            backup_me="/app/OFM/OFM_QA/Middleware/Oracle_Home"
        ...
        "soa full backup")
            ...
            backup_me="/app_domain/OFM_Domains/OFM_QA/user_projects/qa_soa_domain /app/OFM/OFM_QA/Middleware/Oracle_Home"            
...
java weblogic.WLST -skipWLSModuleScanning /app_data/scripts/startup_shutdown_scripts/stopOSBServers.py QA osb_managed_server1 osb_managed_server2                     
...
java weblogic.WLST -skipWLSModuleScanning /app_data/scripts/startup_shutdown_scripts/startOSBServers.py QA osb_managed_server1 osb_managed_server2
